...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["user-user-module"], {
  ...
  function srcAppUserUserPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      ...
      _createClass(UserPage, [{
        ...
        value: function saveAddress() {
          this.userService.changeHomeAddress(this.home).subscribe(function (res) {});
          this.userService.changeWorkAddress(this.work).subscribe(function (res) {});
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_services_user_service__WEBPACK_IMPORTED_MODULE_2__["UserService"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"]])], UserPage);
    /***/
  }
}]);
